...
All notable changes to Kiroween (formerly Dark Productivity Suite) will be documented in this file.
...
### Changed
- **Project Renamed**: Changed project name from "dark-productivity-suite" to "kiroween" in package.json
  - Updated npm package name for better branding
  - All functionality remains the same
  - Documentation updated to reflect new name

### Added
- **Agent Hooks System**: Automated AI assistance that triggers based on user actions
  - Sentence Completion Hook for Ghost Writer module
  - Intelligent completions as you type (2+ characters)
  - 300ms debounce for responsive suggestions
  - 1-3 contextual completion options
  - Writing style and tone matching
  - 5-minute caching for performance
  - Accept with Tab or Arrow Right keys
  - Dismiss with Escape key
  - Configurable via JSON hook files in `.kiro/hooks/`
  - Full documentation in AGENT_HOOKS_GUIDE.md
